            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="SvCargarOdontologos">Ver Odontologos</a>
                        <a class="collapse-item" href="SvAltaOdontologo">Crear Odontologos</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="SvListaResponsables">Crear Paciente</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUsers" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="altaUsuario.jsp">Crear Usuarios</a>
                    </div>
                </div>
            </li>
